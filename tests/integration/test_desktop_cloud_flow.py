...
def test_desktop_to_cloud_end_to_end(tmp_path):
    ...
    def dispatch(task_id):
        def work():
            ...
            awareness = SystemAwarenessManager(
                MockProbe(
                    SystemSnapshot(
                        ...
                        architecture="x86_64",
                        cpu=CpuInfo(
                            model="t", logical_processors=4, utilization_percent=20.0
                        ),
                        memory=MemoryInfo(
                        ...
                        capabilities=Capabilities(
                            python_available=True, storage_available=True
                        ),
            ...
            messages.handoff(
                "researcher", "analyst", task_id, "findings: entry points", "corr-e2e"
            )
