...
class LocalHttpServer:
    """Threaded HTTP server. Remote binds require a non-empty auth token."""
    ...
    def __init__(self, api: RuntimeAPI, host: str = "127.0.0.1", port: int = 0,
        ...
        if host in LOOPBACK_HOSTS and not auth_token:
            raise ApiError("unauthorized", "API server requires an authentication token")
