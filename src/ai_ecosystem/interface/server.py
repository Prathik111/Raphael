...
def _error_code(exc: Exception) -> tuple[int, str]:
    if isinstance(exc, ApiError):
        table = {"malformed_request": 400, "invalid_transition": 409, "unsupported": 501,
                 "unavailable": 503, "unauthorized": 401, "forbidden": 403, "queue_full": 429}
    ...
    def _route(self) -> None:
        ...
        try:
            if method == "GET" and parts == ["health"]:
                ...
                body = self._read_json(); goal = body.get("goal") if isinstance(body, dict) else None
...
class LocalHttpServer:
    ...
    def __init__(self, api: RuntimeAPI, host: str = "127.0.0.1", port: int = 0,
                 allow_remote: bool = False, auth_token: str | None = None) -> None:
