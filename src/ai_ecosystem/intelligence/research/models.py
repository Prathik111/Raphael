...
STOPWORDS = frozenset(
    ["a", "an", "the", "and", "or", "but", "of", "to", "in", "on", "for", "with", "is", "are", "was", "were", "be", "been", "it", "its", "this", "that", "these", "those", "as", "at", "by", "from", "into", "over", "after", "such", "no", "not", "only", "also", "than", "then", "there", "their", "what", "when", "where", "which", "who", "will", "can", "has", "have", "had", "do", "does", "did", "how", "why", "vs", "via", "per"]
)
